...
public class JsoupHTMLParser implements DOMParser {
    public JsoupHTMLParser() {
    }

    public NodeInfo parse(InputStream inputStream) {
        try {
    ...
    private NodeInfo traverse(org.jsoup.nodes.Node node, Integer index, Deque<NodeBuilder> treeDepth) {
